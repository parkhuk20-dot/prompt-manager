...
![카테고리 스크린샷](screenshots/category.png)
...
![즐겨찾기 스크린샷](screenshots/favorite.png)
...
- [x] 터미널에서 Python/Git 버전 확인 및 설정 점검 (버전 + user.name/user.email 출력)
